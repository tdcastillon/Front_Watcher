...
const TvShowPeopleCard = (props: {id: string, poster_path: string, title: string, first_air_date: string, last_air_date: string, character: string, episodeCount: number }) => {
    ...
    return (
        <Box display="inline-block" style={{ margin: '10px 5px' }}>
            <Card sx={{ width: '225px !important', height: '500px !important', flex: 1, backgroundColor: '#F0F0F0', boxShadow: '5px 5px 5px -5px #2d2a32' }}>
                <CardMedia
                    component="img"
                    height="140"
                ...
                />
                <CardContent>
                    <Typography gutterBottom variant="body1" component="div" style={{display: 'flex', flexWrap: 'wrap', fontSize: '1rem', height: '40px', flexDirection: 'row'}}>
                        {props.title}
                    </Typography>
