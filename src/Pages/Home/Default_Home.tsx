...
function Default_Home() {
    return (
        <div className="Home">
            ...
            <div className="Body">
                <p className="description">The Watcher est un site te permettant de noter les films et séries que tu as vus ! Tu pourras de cette
                maniére savoir quels films tu as vus. Il s'agit également d'une app comunautaire dans laquelle tu pourras également voir les notes mises par tes amis ! </p>
            </div>
